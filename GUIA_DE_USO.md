...
- Te muestra quién ha entrenado hoy.
...
- **Si alguien deja de entrenar**: Puedes desactivarlo para que no te moleste en la lista, pero sus datos se guardarán por si vuelve.
...
3. Busca el ejercicio (ej: "Pecho" -> "Press de Banca").
4. Pon cuántos kilos ha levantado y cuántas veces lo ha hecho.
5. Pulsa el botón verde **"Guardar en el Programa"**. ¡Y listo!
...
4. El programa escribirá todo lo que lea. Revisa que no se haya equivocado en algún número y dale a guardar.
...
- Si te dice que **NO**, el programa lo pondrá en la lista de "inactivos" hasta que pague.
