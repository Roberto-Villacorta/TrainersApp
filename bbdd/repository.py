...
class DashboardRepository:
    ...
    def obtener_atletas_activos(self) -> list[Atleta]:
        """Devuelve todos los atletas con estado 'activo'."""
        return self.session.query(Atleta).filter(Atleta.estado == "activo").all()
    ...
    def eliminar_llamadas_por_nombre(self, nombre: str):
        """Elimina todas las llamadas que coincidan exactamente con el nombre proporcionado."""
        self.session.query(Llamada).filter(Llamada.nombre == nombre).delete()
