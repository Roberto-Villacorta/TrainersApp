...
class Usuario(Base):
    """
    Clase añadida para compatibilidad con llamadas externas o residuos de versiones anteriores.
    Previene el error 'no such table: usuarios' en el entorno de Windows.
    """
