...
class ListadoAtletas(ctk.CTkFrame):
    def __init__(self, master, **kwargs):
        ...
        self.btn_ver_activos = ctk.CTkButton(self.frame_botones, text="Ver Activos", command=self.mostrar_activos)
        self.btn_ver_activos.pack(side="left", padx=10)
        
        self.btn_ver_inactivos = ctk.CTkButton(self.frame_botones, text="Ver Inactivos", fg_color="gray", hover_color="gray50", command=self.mostrar_inactivos)
        self.btn_ver_inactivos.pack(side="left", padx=10)
    ...
    def mostrar_ayuda(self):
        ...
        msg = (
            ...
            "3. BOTONES DE VISTA: Usa 'Ver Activos' o 'Ver Inactivos' para filtrar a tus alumnos según su estado.\n\n"
    ...
    def mostrar_activos(self):
        self.viendo_inactivos = False
        self.btn_ver_activos.configure(fg_color=("#3b8ed0", "#1f6aa5"))
        self.btn_ver_inactivos.configure(fg_color="gray")
        self.renderizar_lista()

    def mostrar_inactivos(self):
        self.viendo_inactivos = True
        self.btn_ver_activos.configure(fg_color="gray")
        self.btn_ver_inactivos.configure(fg_color=("#3b8ed0", "#1f6aa5"))
        self.renderizar_lista()
    ...
    def abrir_actualizar(self):
        ...
        if not atletas:
            messagebox.showwarning("Atención", "No hay atletas registrados registra uno")
            return
